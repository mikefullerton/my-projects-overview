...
| [Agentic Daemon](projects/agenticdaemon/overview.md) | User-space daemon watching a jobs directory for Swift scripts and running them on schedule | Swift 6, strict concurrency, launchd |
...
| [Cookbook Web](projects/agenticcookbookweb/overview.md) | Public website for the Agentic Cookbook at agentic-cookbook.com | React 19, TypeScript, Tailwind 4, Vite, Cloudflare Workers |
| [Cookbook Backend](projects/agenticcookbookbackend/overview.md) | npm workspaces monorepo: Hono/Drizzle/Postgres backend, auth service, admin/dashboard sites | Node, TypeScript, Hono, Drizzle, PostgreSQL, Cloudflare Workers, Railway |
...
| [Dev Tools](projects/devtools/overview.md) | Distributable Claude Code skills for scaffolding, deployment, and repo maintenance | Python 3.11+, TypeScript, Vitest |
| [Devtools Web Server](projects/devtoolswebserver/overview.md) | Always-on local Caddy server with site lifecycle API and live dashboard | Caddy, Python, React, TypeScript |
...
| [Agentic Auth Service](projects/agenticauthservice/overview.md) | Shared RS256 JWT authentication microservice for the agentic ecosystem | Node.js, Hono, TypeScript, PostgreSQL, Drizzle, Railway |
...
| [Official Agent Registry](projects/agenticregistry/overview.md) | "DNS for AI agents" — identity platform for registering and discovering AI agents | TypeScript, React, Hono, PostgreSQL, Cloudflare Workers |
...
| [Persona Creator](projects/personacreator/overview.md) | Python library + Claude Code skill generating AI personas with visual character generation | Python 3.12+, Pydantic, Click, httpx |
| [Shared Website Components](projects/agenticwebtoolkit/overview.md) | React 19 component library (Agentic theme system + chat widget) consumed via git submodule | React 19, TypeScript, Vite, Vitest |
...
| Project | Summary | Tech |
|---------|---------|------|
| [Cat Herding](projects/catherding/overview.md) | Personal Claude Code workflow extensions — yolo, custom-status-line, linting skills | Python, YAML |
| [Social Media Bot](projects/socialmediabot/overview.md) | AI content pipeline of 12 sequential bots drafting posts for X/LinkedIn/Bluesky/Substack | Python, claude-agent-sdk, click, SQLite |
...
| [My Projects](projects/myprojects/overview.md) | Project management dashboard tracking ~35 git repos | React 19, Vite, Node.js, Python scanners |
